...
//this code was given and the gode is to write a junit test class to test the general method functionality and the edge
// cases that can occur in the methods
public class Utilities {
    ...
    public String removePairs(String source) {
        ...
        char[] string = source.toLowerCase().toCharArray();
